const CACHE_NAME = 'kaitiaki-camera-v13';
const IMAGE_CACHE = 'kaitiaki-camera-images-v1';
const APP_SHELL = ['./','./index.html','./manifest.webmanifest','./sw.js','./runtime-fix.js','./bulk-training.js'];
...
async function patchHtml(response){
  ...
  try{
    ...
    if(!patched.includes('bulk-training.js')) patched=patched.replace('</body>','<script src="./bulk-training.js?v=1"></script>\n</body>');
